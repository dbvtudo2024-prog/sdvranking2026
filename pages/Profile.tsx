...
import { Save, User as UserIcon, Camera, ChevronDown, Trophy, BookOpen, Medal, ShieldCheck, Check, Shield } from 'lucide-react';
    ...
    <div className="h-full overflow-y-auto pb-32 animate-in fade-in duration-500 scroll-smooth" style={{ overscrollBehaviorY: 'contain' }}>
      <div className="px-4 pt-8 space-y-6">
        ...
        <div className="bg-white p-8 rounded-[3rem] border border-slate-50 shadow-xl shadow-blue-900/5 space-y-6">
          <h3 className="font-black text-[#94a3b8] text-[10px] uppercase tracking-[0.2em] px-2">Meus Dados</h3>
