...
CREATE TABLE IF NOT EXISTS who_am_i_questions (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, content TEXT, correct_answer TEXT, clues JSONB, created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW());
...
CREATE TABLE IF NOT EXISTS quiz_questions (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, question TEXT, options JSONB, correct_answer INTEGER, category TEXT, created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW());
...
-- 2. GARANTIR QUE TODAS AS COLUNAS EXISTAM (CASO A TABELA JÁ EXISTA INCOMPLETA)
...
DECLARE
    t TEXT;
    tables TEXT[] := ARRAY['devotionals', 'quizzes', 'who_am_i_questions', 'three_clues_questions', 'quiz_questions', 'EspecialidadesDBV', 'game_configs', 'game_assets', 'members', 'messages', 'announcements', 'specialty_studies', 'scrambled_verses', 'puzzle_images', 'users', 'desbravadores', 'especialidades'];
BEGIN
