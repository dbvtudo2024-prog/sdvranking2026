...
{`-- 1. ESTRUTURA COMPLETA (MAIS ROBUSTA)
CREATE TABLE IF NOT EXISTS users (id UUID PRIMARY KEY DEFAULT auth.uid(), email TEXT, full_name TEXT, avatar_url TEXT, role TEXT DEFAULT 'user', password TEXT, created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW());
...
-- 2. AJUSTES DE COLUNA E COMPATIBILIDADE
ALTER TABLE IF EXISTS users ALTER COLUMN password DROP NOT NULL;
ALTER TABLE IF EXISTS specialty_studies ADD COLUMN IF NOT EXISTS scheduled_for TIMESTAMP WITH TIME ZONE;
...
-- 3. PERMISSÕES ACESSO PÚBLICO (Mestre)
DO $$ 
DECLARE
    t TEXT;
