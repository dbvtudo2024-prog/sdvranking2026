...
-- 2. CRIAR TABELA DEVOCIONAIS (SE NÃO EXISTIR)
...
-- 3. CRIAR TABELA QUIZZES (PARA SALVAR RESULTADOS)
...
-- 4. CRIAR TABELAS DE APOIO PARA JOGOS
...
-- 5. TABELA DE CONFIGURAÇÕES DE JOGOS
