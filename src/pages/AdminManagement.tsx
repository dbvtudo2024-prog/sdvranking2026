...
CREATE TABLE IF NOT EXISTS specialty_study_questions (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, study_id UUID, question TEXT, options JSONB, correct_answer INTEGER);
