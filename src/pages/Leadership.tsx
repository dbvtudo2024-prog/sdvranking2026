    ...
    <div className="flex flex-col h-full bg-[#f8fafc] dark:bg-[#0f172a] animate-in fade-in duration-500 overflow-y-auto">
      ...
      {selectedLeader && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 w-full max-w-sm rounded-[3.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95">
            ...
            <div className="pt-16 p-8 pb-10 text-center space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-50 dark:border-slate-700">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm font-black text-slate-700 dark:text-slate-300 truncate w-full text-center">
