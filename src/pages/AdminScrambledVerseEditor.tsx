...
import { SCRAMBLED_VERSES_DATA } from '@/constants';
import { Edit2, Trash2, X, ChevronDown, Save, Search, Plus, Loader2, Type, DownloadCloud } from 'lucide-react';
      ...
      <div className="p-4 sm:p-6 space-y-4 flex-1 overflow-y-auto pb-32">
        <div className="flex justify-between items-center">
           ...
           <div className="flex gap-2">
            <button 
              onClick={async () => {
                if (!confirm('Importar os versículos padrão?')) return;
                setIsSaving(true);
                try {
                  await DatabaseService.seedScrambledVerses(SCRAMBLED_VERSES_DATA);
                  alert('✅ Versículos importados com sucesso!');
                } catch (e: any) { 
