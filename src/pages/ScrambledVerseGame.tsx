          ...
          {gameState === 'loading' ? (
            ...
            >
              ...
              <div className="bg-slate-50 dark:bg-slate-900 w-full p-6 rounded-3xl border-2 border-slate-100 dark:border-slate-800">
                ...
                <p className="text-4xl font-black text-blue-600 mb-4">{score} PTS</p>
              ...
              <button 
                onClick={onBack}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-[2rem] font-black uppercase tracking-widest transition-all active:scale-95 shadow-xl shadow-blue-500/10 text-xs"
              >
                CONFIRMAR E VOLTAR
              </button>
            </motion.div>
