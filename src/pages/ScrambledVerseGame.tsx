      ...
      played = (currentMember.scores || []).some(s => {
        ...
        if (isNaN(scoreDate.getTime())) {
          ...
          if (parts.length === 3) {
            ...
            return d >= cycleStart && ((s as any).scrambledVerseGame !== undefined || s.gameId === 'scrambledVerseGame');
          }
          return false;
        }
        return scoreDate >= cycleStart && ((s as any).scrambledVerseGame !== undefined || s.gameId === 'scrambledVerseGame');
      });
    }
