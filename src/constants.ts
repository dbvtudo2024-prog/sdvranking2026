...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  { id: 'n6', category: 'Natureza', question: 'Qual é o nome desta flor?', options: ['Rosa', 'Girassol', 'Margarida', 'Tulipa'], correctAnswer: 1, image_url: 'https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&q=80&w=512' },
  { id: 'n7', category: 'Natureza', question: 'Que animal é este?', options: ['Esquilo', 'Castor', 'Marmota', 'Guaxinim'], correctAnswer: 0, image_url: 'https://images.unsplash.com/photo-1507666405821-4223cf1ad7fc?auto=format&fit=crop&q=80&w=512' },
  { id: 'n8', category: 'Natureza', question: 'Qual o nome desta árvore?', options: ['Ipê Amarelo', 'Jacarandá', 'Seringueira', 'Pau-Brasil'], correctAnswer: 0, image_url: 'https://images.unsplash.com/photo-1596436889106-be35e843f974?auto=format&fit=crop&q=80&w=512' },
  { id: 'n9', category: 'Natureza', question: 'Identifique esta constelação:', options: ['Orion', 'Cruzeiro do Sul', 'Ursa Maior', 'Escorpião'], correctAnswer: 1, image_url: 'https://images.unsplash.com/photo-1539185441755-769473a23570?auto=format&fit=crop&q=80&w=512' },
  { id: 'n10', category: 'Natureza', question: 'Que tipo de nuvem é esta?', options: ['Cirrus', 'Cumulus', 'Stratus', 'Nimbus'], correctAnswer: 1, image_url: 'https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&q=80&w=512' },
  ...
  { id: 'ps6', category: 'Primeiros Socorros', question: 'O que fazer em caso de picada de cobra?', options: ['Fazer um torniquete', 'Sugar o veneno', 'Manter a vítima calma e levar ao hospital', 'Cortar o local da picada'], correctAnswer: 2, tip: 'Manter a calma evita que o veneno se espalhe mais rápido. O hospital aplicará o soro antiofídico.' },
  { id: 'ps7', category: 'Primeiros Socorros', question: 'Como ajudar alguém tendo uma convulsão?', options: ['Segurar a língua da pessoa', 'Colocar algo na boca', 'Proteger a cabeça e afastar objetos próximos', 'Dar água'], correctAnswer: 2, tip: 'Nunca coloque nada na boca. Apenas evite que a pessoa se machuque batendo a cabeça.' },
  { id: 'ps8', category: 'Primeiros Socorros', question: 'Qual a primeira atitude ao encontrar alguém inconsciente?', options: ['Tentar acordar com tapas', 'Verificar se o local é seguro e checar resposta', 'Começar massagem cardíaca direto', 'Chamar pelo nome'], correctAnswer: 1, tip: 'Segurança em primeiro lugar para o socorrista, depois avalie a vítima.' },
  { id: 'ps9', category: 'Primeiros Socorros', question: 'O que significa a sigla RCP?', options: ['Retorno de Circulação Pulmonar', 'Reanimação Cardiopulmonar', 'Resgate de Corpo Parado', 'Reação de Coração e Pulmão'], correctAnswer: 1, tip: 'A Reanimação Cardiopulmonar é essencial para manter o fluxo de sangue no cérebro.' },
  { id: 'ps10', category: 'Primeiros Socorros', question: 'Em caso de desmaio, como posicionar a pessoa?', options: ['Sentada', 'Deitada com as pernas elevadas', 'De bruços', 'De pé'], correctAnswer: 1, tip: 'Elevar as pernas ajuda o sangue a retornar mais facilmente para o cérebro.' },

  // Categoria Especialidades
  { id: 'e1', category: 'Especialidades', question: 'Qual o nó utilizado para unir duas cordas de espessuras diferentes?', options: ['Nó de Escota', 'Nó Direito', 'Lais de Guia', 'Catau'], correctAnswer: 0 },
  { id: 'e2', category: 'Especialidades', question: 'Na especialidade de Astronomia, qual o nome da estrela mais próxima da Terra depois do Sol?', options: ['Sirius', 'Proxima Centauri', 'Betelgeuse', 'Vega'], correctAnswer: 1 },
  { id: 'e3', category: 'Especialidades', question: 'Qual o principal objetivo da especialidade de Arte de Acampar?', options: ['Aprender a fazer fogo', 'Saber montar barracas', 'Desenvolver autossuficiência e contato com a natureza', 'Ganhar um distintivo'], correctAnswer: 2 },
  { id: 'e4', category: 'Especialidades', question: 'Na especialidade de Cães, qual sentido é mais desenvolvido nesses animais?', options: ['Visão', 'Audição', 'Olfato', 'Tato'], correctAnswer: 2 },
  { id: 'e5', category: 'Especialidades', question: 'Qual destes é um requisito básico da especialidade de Natação I?', options: ['Nadar 1km', 'Saber mergulhar de cabeça', 'Nadar 25 metros sem parar', 'Fazer saltos ornamentais'], correctAnswer: 2 },
  { id: 'e6', category: 'Especialidades', question: 'Na especialidade de Gatos, qual a principal característica dos felinos?', options: ['Garras retráteis', 'Visão noturna ruim', 'Não gostam de dormir', 'São animais de matilha'], correctAnswer: 0 },
  { id: 'e7', category: 'Especialidades', question: 'Qual o nome do nó que nunca corre e é usado para fazer uma alça fixa?', options: ['Nó de Correr', 'Lais de Guia', 'Nó de Pescador', 'Nó de Oito'], correctAnswer: 1 },
  { id: 'e8', category: 'Especialidades', question: 'Na especialidade de Computação I, o que significa a sigla CPU?', options: ['Central de Processamento Único', 'Unidade Central de Processamento', 'Computador Pessoal de Usuário', 'Controle de Processos Úteis'], correctAnswer: 1 },
  { id: 'e9', category: 'Especialidades', question: 'Qual destes é um item essencial para um acampamento de desbravadores?', options: ['Videogame', 'Bíblia e material de estudo', 'Televisão', 'Móveis pesados'], correctAnswer: 1 },
  { id: 'e10', category: 'Especialidades', question: 'Na especialidade de Aves, qual o nome do maior pássaro do mundo?', options: ['Águia Real', 'Condor', 'Avestruz', 'Ema'], correctAnswer: 2 }
];
